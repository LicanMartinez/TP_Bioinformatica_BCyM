...
# índice T/F de muestras que pertenecen al subconjunto especificado
...
res = results(de.an, contrast = c('Sex', 'M', 'F')) %>% 
  as.data.frame() %>% 
  select(-c(4:5)) # borrar algunas columans que no son de interés
...
```{r para diapositiva, echo=F, include=F, fig.width=8, fig.height=3}
